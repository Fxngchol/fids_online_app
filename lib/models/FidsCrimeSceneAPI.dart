...
class FidsCrimeSceneAPI {
  ...
  Future<List<FidsCrimeSceneAPI>> generateModel(FidsCrimeScene data) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var uGroup = prefs.getString('uGroup');

    FidsCrimeSceneAPI response = FidsCrimeSceneAPI();
