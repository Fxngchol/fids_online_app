...
class FidsCrimeSceneWitnessCasePersonAPI {
  String? fidsNo;
  String? departmentId;
  ...
  FidsCrimeSceneWitnessCasePersonAPI(
      {this.fidsNo,
      this.departmentId,
      this.casecategoryId,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'exhibit_location': exhibitLocation == 'null' ? '' : exhibitLocation,
      'exhibit_date': exhibitDate == 'null' ? '' : exhibitDate,
      'exhibit_time': exhibitTime == 'null' ? '' : exhibitTime,
    };
  }

  Future<List<FidsCrimeSceneWitnessCasePersonAPI>> generateModel(
      FidsCrimeScene data) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var uGroup = prefs.getString('uGroup');

    FidsCrimeSceneWitnessCasePersonAPI response =
        FidsCrimeSceneWitnessCasePersonAPI();
    ...
    List<FidsCrimeSceneWitnessCasePersonAPI> go = [];
    go.add(response);
    return go;
  }
}
