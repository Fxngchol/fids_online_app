...
import '../../life_case/result_case/result_case.dart';

class MainMenuWitnessCrimeScene extends StatefulWidget {
  final int? caseID;
  final String? caseNo;
  final bool isLocal;

  const MainMenuWitnessCrimeScene(
      {super.key, required this.caseID, this.caseNo, this.isLocal = false});

  @override
  MainMenuWitnessCrimeSceneState createState() =>
      MainMenuWitnessCrimeSceneState();
}

class MainMenuWitnessCrimeSceneState extends State<MainMenuWitnessCrimeScene> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBarWidget(
        title: 'คดีตรวจเก็บวัตถุพยานที่เกิดเหตุ',
        leading: IconButton(
            icon: isIOS
              ...
              : Container(
                  ...
                  child: ListView(
                    children: [
                      ...
                      spacer(context),
                      header('8.การส่งมอบสถานที่เกิดเหตุ'),
