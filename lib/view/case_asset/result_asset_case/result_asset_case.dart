...
import 'edit_result_asset_case.dart';

class ResultAssetCase extends StatefulWidget {
  final int? caseID;
  final String? caseNo;
  final bool isLocal;

  const ResultAssetCase(
      {super.key, this.caseID, this.caseNo, this.isLocal = false});
  @override
  ResultAssetCaseState createState() => ResultAssetCaseState();
}

class ResultAssetCaseState extends State<ResultAssetCase> {
            ...
            TextButton(
              onPressed: () async {
                var result = await Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            EditResultAsset(caseID: widget.caseID)));
