...
class SelectSubDepartment extends StatefulWidget {
  final int departID;
  const SelectSubDepartment(this.departID, {super.key});

  @override
  SelectSubDepartmentState createState() => SelectSubDepartmentState();
}

class SelectSubDepartmentState extends State<SelectSubDepartment> {
  ...
  void asyncCall() async {
    var result = await DepartmentDao().getDepartmentByRootId(widget.departID);
    setState(() {
      masterData = result;
      data = List<Department>.from(masterData);
    });
