...
class SelectPosition extends StatefulWidget {
  ...
  @override
  SelectPositionState createState() => SelectPositionState();
}

class SelectPositionState extends State<SelectPosition> {
  bool isPhone = Device.get().isPhone;
  List<Position> data = [];
  List<Position> masterData = [];
      ...
      child: InputFieldWithIcon(
        ...
        onChanged: (value) {
          if (value.isEmpty || value == '') {
            setState(() {
              data = List<Position>.from(masterData);
            });
            return;
          }
  ...
  void asyncCall() async {
    var result = await PositionDao().getPosition();
    setState(() {
      masterData = result;
      data = List<Position>.from(masterData);
    });
